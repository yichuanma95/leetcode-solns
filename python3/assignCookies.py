...
size of a cookie that the child will be content with; and each cookie j has a size sj. If
s_j >= g_i, we can assign the cookie j to the child i, and the child i will be content. Your
...
whose greed factor is 1 content. Therefore, you need to output 1.
