...
the input will be given as signed integer type and should not affect your implementation, as
...
Solution runtime: 20ms, faster than 98.67% of Python3 submissions
...
class Solution:
    def hammingWeight(self, n: int) -> int:
        ...
        Returns the Hamming weight of n, an unsigned integer.
        '''
